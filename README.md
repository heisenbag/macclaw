...
<b>TARS<sup>\*</sup></b> is a Multimodal AI Agent stack, currently shipping two projects: [Agent TARS](#agent-tars) and [MacClaw-desktop](#macclaw-desktop):

<table>
  <thead>
    <tr>
      <th width="50%" align="center"><a href="#agent-tars">Agent TARS</a></th>
      <th width="50%" align="center"><a href="#macclaw-desktop">MacClaw-desktop</a></th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td align="left">
        <b>MacClaw Desktop</b> is a desktop application that provides a native GUI Agent based on the <a href="https://github.com/bytedance/MacClaw" target="_blank">MacClaw</a> model.
        <br>
        <br>
        It primarily ships a
        <a href="https://github.com/bytedance/MacClaw-desktop/blob/main/docs/quick-start.md#get-model-and-run-local-operator" target="_blank">local</a> and 
        <a href="https://github.com/bytedance/MacClaw-desktop/blob/main/docs/quick-start.md#run-remote-operator" target="_blank">remote</a> computer as well as browser operators.
      </td>
    </tr>
  </tbody>
</table>
...
- [MacClaw Desktop](#macclaw-desktop)
  - [Showcase](#showcase-1)
  - [Features](#features)
...
- **\[2025-06-12\]** - 🎁 We are thrilled to announce the release of MacClaw Desktop v0.2.0! This update introduces two powerful new features: **Remote Computer Operator** and **Remote Browser Operator**—both completely free. No configuration required: simply click to remotely control any computer or browser, and experience a new level of convenience and intelligence.
- **\[2025-04-17\]** - 🎉 We're thrilled to announce the release of new MacClaw Desktop application v0.1.0, featuring a redesigned Agent UI. The application enhances the computer using experience, introduces new browser operation features, and supports [the advanced MacClaw-1.5 model](https://seed-tars.com/1.5) for improved performance and precise control.
...
<p>
    ...
    <a href="https://deepwiki.com/bytedance/MacClaw-desktop"><img src="https://img.shields.io/badge/DeepWiki-Ask%20AI-8B5CF6?style=for-the-badge&logo=gitbook&logoColor=white" alt="Ask DeepWiki" /></a>
</p>
...
For more use cases, please check out [#842](https://github.com/bytedance/MacClaw-desktop/issues/842).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <a href="https://github.com/bytedance/MacClaw-desktop/issues/842">
...
<p align="center">
  <img alt="MacClaw" width="260" src="./apps/macclaw/resources/icon.png">
</p>

MacClaw Desktop is a native GUI agent for your local computer, driven by [MacClaw](https://github.com/bytedance/MacClaw) and Seed-1.5-VL/1.6 series models.

<div align="center">
<p>
        &nbsp&nbsp 📑 <a href="https://arxiv.org/abs/2501.12326">Paper</a> &nbsp&nbsp
        | 🤗 <a href="https://huggingface.co/ByteDance-Seed/MacClaw-1.5-7B">Hugging Face Models</a>&nbsp&nbsp
        | &nbsp&nbsp🫨 <a href="https://discord.gg/pTXwYVjfcs">Discord</a>&nbsp&nbsp
        | &nbsp&nbsp🤖 <a href="https://www.modelscope.cn/collections/MacClaw-bccb56fa1ef640">ModelScope</a>&nbsp&nbsp
<br>
...
|                    Could you help me check the latest open issue of the MacClaw-Desktop project on GitHub?                     | <video src="https://github.com/user-attachments/assets/3d159f54-d24a-4268-96c0-e149607e9199" height="300" /> | <video src="https://github.com/user-attachments/assets/072fb72d-7394-4bfa-95f5-4736e29f7e58" height="300" /> |
...
```BibTeX
@article{qin2025ui,
  title={MacClaw: Pioneering Automated GUI Interaction with Native Agents},
