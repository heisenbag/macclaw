...
const ChatInput = ({
  ...
  useEffect(() => {
    if (status === StatusEnum.INIT) {
      if (initialPrompt && !running && localInstructions === initialPrompt) {
      ...
      <div className="flex flex-col space-y-4">
        <div className="relative w-full">
          <Textarea
            ...
            className="min-h-[120px] rounded-2xl resize-none px-4 pb-16 glass-panel-heavy focus-visible:ring-1 focus-visible:ring-white/30 border-white/20" // 调整内边距
