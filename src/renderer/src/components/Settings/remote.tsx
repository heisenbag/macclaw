  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-[480px] max-h-[80vh] flex flex-col">
        ...
        >
          <div
            className={`sticky top-0 left-0 right-0 h-10 bg-gradient-to-b from-background to-transparent z-10 pointer-events-none transition-opacity duration-200 ${scrollStatus.isAtTop ? 'opacity-0' : 'opacity-100'
              }`}
          />
          ...
          />
          <div
            className={`sticky bottom-[-1px] left-0 right-0 h-10 bg-gradient-to-t from-background to-transparent z-10 pointer-events-none transition-opacity duration-200 ${scrollStatus.isAtBottom ? 'opacity-0' : 'opacity-100'
              }`}
          />
        </div>
